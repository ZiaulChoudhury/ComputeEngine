...
//
// On Sun May 30 12:03:24 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlowTest(CLK,
  ...
  assign MUX_px$loadConfig_1__VAL_2 =
	     idx_4_ULT_3___d15 ? 16'd32 : { 8'd0, b__h721 } ;
  ...
  assign b__h721 = { 3'd0, _7_MINUS_idx2__q1[2:0], 2'd0 } ;
  ...
  assign x__h3192 =
	     rx_0_MUL_cx_6_5_BITS_9_TO_0_6_PLUS_10___d47[9] ?
	       -rx_0_MUL_cx_6_5_BITS_9_TO_0_6_PLUS_10___d47 :
	       rx_0_MUL_cx_6_5_BITS_9_TO_0_6_PLUS_10___d47 ;
  assign x__h924 = count[31] ? -count : count ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive) $display(" %d ", $signed(px$get[47:33]));
    if (RST_N != `BSV_RESET_VALUE)
