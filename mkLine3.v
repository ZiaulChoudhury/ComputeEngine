...
//
// On Fri Jun 18 03:31:51 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkLine3(CLK,
  ...
  wire [63 : 0] _unnamed_$enQdeQ_a, _unnamed_$enq_a, _unnamed_$read;
  ...
  assign _unnamed_$enQdeQ_a =
	     (r1 == 9'd0) ?
	       instream$D_OUT :
	       { _unnamed__1$read[15:0], _unnamed_$read[63:16] } ;
  ...
  assign _unnamed__1$enQdeQ_a =
	     (r1 == 9'd1) ?
	       instream$D_OUT :
	       { _unnamed__2$read[15:0], _unnamed__1$read[63:16] } ;
  ...
  assign _unnamed__2$enQdeQ_a =
	     (r1 == 9'd2) ?
	       instream$D_OUT :
	       { _unnamed__3$read[15:0], _unnamed__2$read[63:16] } ;
  ...
  assign _unnamed__3$enQdeQ_a =
	     (r1 == 9'd3) ?
	       instream$D_OUT :
	       { _unnamed__4$read[15:0], _unnamed__3$read[63:16] } ;
  ...
  assign _unnamed__4$enQdeQ_a =
	     (r1 == 9'd4) ?
	       instream$D_OUT :
	       { _unnamed__5$read[15:0], _unnamed__4$read[63:16] } ;
  ...
  assign _unnamed__5$enQdeQ_a =
	     (r1 == 9'd5) ?
	       instream$D_OUT :
	       { _unnamed__6$read[15:0], _unnamed__5$read[63:16] } ;
  ...
  assign _unnamed__6$enQdeQ_a =
	     (r1 == 9'd6) ?
	       instream$D_OUT :
	       { _unnamed__7$read[15:0], _unnamed__6$read[63:16] } ;
